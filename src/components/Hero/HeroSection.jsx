...
export default function HeroSection({ abtref }) {
  ...
  if (theme === "light") {
    ...
    classes +=
      " bg-gradient-to-b from-black via-gray-800 to-gray-800 text-[#D4A03E] ";
  }

  return (
    <div
      className="bigContainer flex justify-center items-center z-0"
      id="home"
    >
