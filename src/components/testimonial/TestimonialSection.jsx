...
const testimonials = [
  {
    ...
    content:
      '" He is excellent, I strongly recommend him; his technical skills and dedication make him a standout professional, and he will be an asset to the company. His proactive approach and positive attitude contribute greatly to team success. "',
    image: [man],
  },
  {
    id: 2,
    ...
    content:
      '" Collaborating with Sachin was truly exceptional. He took the lead with a clear vision and inspired the team to achieve more than we thought possible. His ability to navigate challenges and deliver results ahead of schedule was impressive. You can easily trust him with all your development queries.   "',
    image: [shikhu],
  },
  {
    id: 3,
    ...
    content:
      '" We had a wonderful experience working with Sachin. He managed to work and lead the team and deliver the results before the expected timeline. He is hardworking, passionate and great asset to the team. "',
    image: [marcaids],
  },
  {
    id: 4,
    ...
    role: "CEO, Chaotix.AI",
    content:
      '" Sachin made a remarkable impact during his brief time with us as an AI intern. Despite the short duration, he demonstrated leadership by taking charge of the team and driving progress effectively. His technical expertise and dedication were so impressive. "',
    image: [chao],
  },
];
...
export default function TestimonialSection() {
  ...
  return (
    <div
      id="testimonials"
      className={`testimonial-section min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ${themeClasses}`}
    >
