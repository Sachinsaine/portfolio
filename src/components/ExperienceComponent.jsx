...
const experiences = [
  {
    ...
    description:
      "As a Software Engineer,I support the Refinitiv Connected Risk Management Application across DEV, UAT, and Production. I handle application maintenance, user interactions for issue resolution, and manage SSL/TLS certificates, strengthening my debugging skills and client liaison abilities.",
    skills: [
      "Javascript",
      "HTML",
      "CSS",
  ...
  },
  {
    ...
    description:
      "I lead impactful AI development, specializing in machine learning and web development to create engaging, seamless experiences. At Chaotix.AI, I thrive in team-driven projects, integrating AI and creativity into captivating web games.",
  ...
  },
  {
    ...
    description:
      "Worked on Salary Prediction Dashboard for HRs! Using Python and Excel, I created a dataset with 200,000 datapoints, including attributes like Name, Age, Salary, and Experience. Focusing on building new skills, strengthening concepts, and applying them in real projects",
  ...
  },
  {
    ...
    description:
      "Started my journey in web development, working on various client projects and honing my skills in HTML, CSS, and JavaScript.",
    ...
    >
      <div
        className={`rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl ${
          theme === "light"
            ? "bg-gray-700"
            : "bg-gray-900 hover:shadow-[#D4A03E]/20"
        }`}
      >
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3
              className={`text-2xl font-bold ${
                theme === "light" ? "text-white" : "text-[#D4A03E]"
              }`}
            >
              {experience.title}
            </h3>
          ...
          <p
            className={`${
              theme === "dark" ? "text-white" : "text-[#D4A03E]"
            } mb-4`}
          >
            {experience.company}
          </p>
          ...
          <div className="flex flex-wrap gap-2">
            {experience.skills.map((skill, skillIndex) => (
              <span
                key={skillIndex}
                className="px-3 py-1 bg-gray-700 text-[#D4A03E] rounded-full text-sm"
              >
                {skill}
              </span>
            ))}
...
const ExperienceComponent = () => {
  ...
  return (
    <div
      className="min-h-screen w-full py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
      id="exp"
    >
      <div className="max-w-4xl mx-auto relative z-10">
        <h2
          ...
          } md:text-5xl sm:text-4xl text-3xl heading mb-20 mt-20`}
        >
          Work Experience
        </h2>
