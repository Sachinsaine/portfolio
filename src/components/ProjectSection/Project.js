...
const projectData = [
  ...
  },
  {
    ...
    techStack: ["Tailwind CSS"],
    description:
      "A streamlined login interface that mimics Facebook's login page, developed with Tailwind CSS.",
  ...
  },
  {
    ...
    techStack: ["React", "Tailwind CSS"],
    description:
      "An intuitive cart management system created with React and Tailwind CSS to streamline online shopping.",
  ...
  },
  {
    ...
    techStack: ["React", "Tailwind CSS"],
    description:
      "A user-friendly investment calculator built with React and Tailwind CSS for calculating potential investment returns.",
  ...
  },
  {
    ...
    techStack: ["React", "Tailwind CSS"],
    description:
      "A task planner application developed with React and Tailwind CSS for efficient task management.",
  ...
  },
  {
    ...
    techStack: ["React", "Tailwind CSS"],
    description:
      "A React-based app that allows users to select and save locations using Tailwind CSS for styling.",
  ...
  },
  {
    ...
    techStack: ["React", "Tailwind CSS"],
    description:
      "An engaging quiz application built with React and Tailwind CSS that tests users' knowledge across various topics.",
  ...
  },
  {
    ...
    techStack: ["React", "Tailwind CSS"],
    description:
      "A fun and interactive game application created using React and Tailwind CSS that challenges users' reflexes.",
  ...
  },
  {
    ...
    techStack: ["React", "Tailwind CSS"],
    description:
      "A modern twist on the classic Tic Tac Toe game, developed with React and Tailwind CSS.",
  ...
  },
  {
    ...
    description:
      "A fully responsive landing page for a gym, designed with JavaScript to showcase services and classes.",
  ...
  },
  {
    ...
    techStack: ["JavaScript"],
    description:
      "A music website created with JavaScript that adapts seamlessly across devices.",
  ...
  },
  {
    ...
    techStack: ["JavaScript"],
    description:
      "A weather application built with JavaScript that provides real-time weather updates.",
  ...
  },
  {
    ...
    techStack: ["JavaScript"],
    description:
      "A simple and effective todo list application created with JavaScript for personal task management.",
  ...
  },
  {
    ...
    techStack: ["Python"],
    description:
      "A Python-based application that utilizes machine learning to identify fake news articles, training 5 models: DT, SVM, LR, RF, GB.",
    projectLink:
      "https://colab.research.google.com/drive/1CuGIvHf7UmPFB_yL5UxubZfNBR7de7Hv#scrollTo=V-sywvSS1k9F",
  },
  {
    ...
    techStack: ["Python"],
    description:
      "A Python project that implements an attendance system using facial recognition technology for enhanced security.",
    projectLink:
      "https://github.com/aayushkakkar26/AttendanceSystemUsingFaceRecognition",
  },
