...
export default function AboutSection() {
  ...
  let classess =
    "about-content flex flex-col lg:flex-row md:flex-row min-h-screen  items-center gap-0 relative z-10   shadow-lg w-[100%]  ";
  if (theme === "light") {
  ...
  return (
    <div id="about" ref={aboutRef} className={classess}>
      <div
        className={`leftAbout md:w-1/2 w-[80%] flex  items-center justify-center transition-transform duration-700 delay-200 ${
      ...
      <div className="details transform transition-all duration-300 absolute md:right-1/2 flex md:flex-col flex-row gap-6 items-center justify-center mt-[90%] md:translate-x-6 md:hover:translate-x-0 md:mt-5 lg:mt-5 bg-white/30 p-3 rounded-lg opacity-80 hover:opacity-100  ">
        <a
          href="tel:+8970070358"
          className="text-black text-3xl hover:text-gray-700 cursor-pointer transition-colors duration-200 -mb-2"
        >
        ...
        <a
          ...
          download
          className="text-black text-3xl hover:text-gray-700 cursor-pointer transition-colors duration-200 -mb-3"
        >
          <PiReadCvLogoFill />
        </a>
        <a
          href="mailto:royalronnie05@gmail.com"
          className=" text-black text-3xl hover:text-gray-700 cursor-pointer transition-colors duration-200 -mb-2"
        >
          <IoMdMail />
        </a>
      ...
      <div
        className={` text-center md:text-left rightAbout mt-10 md:mt-0 lg:mt-0 md:w-1/2 xl:h-screen xl:flex xl:justify-center xl:flex-col  relative md:pt-5 p-4   h-full   shadow-lg transition-transform duration-700 delay-500 ${
      ...
      >
        ...
        <p className="md:text-lg  2xl:text-2xl text-sm leading-relaxed font-medium  mb-3">
          I’m Sachin, a dedicated{" "}
          <span className="font-semibold text-[#D4A03E]">
            Software Engineer
          </span>{" "}
          at Kreativ Web Solutins with a passion for developing elegant and
          efficient web applications. Currently advancing my expertise in
          full-stack development, I have gained experience in React to build
          engaging and dynamic front-end experiences. Driven by curiosity, I am
          committed to continuous learning and innovation in the ever-evolving
          tech landscape.
        </p>
        ...
        <div className="space-y-4 font-medium 2xl:mt-10">
          <p className="flex items-center gap-3">
            ...
            <span className="sm:text-sm 2xl:text-xl">
        ...
        <div className="mt-4 ">
          <h3 className="md:text-xl text-lg font-semibold mb-3 text-yellow-400">
            Tools Worked With
          </h3>
